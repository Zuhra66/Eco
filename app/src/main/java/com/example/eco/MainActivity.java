...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EcoTrackAdapter adapter = new EcoTrackAdapter(new EcoTrackAdapter.EcoTrackLogDiff());
    ...
    private void updateDisplay(){
        ArrayList<EcoTrackLog> allLogs = repository.getAllLogsByUserId(loggedInUserId);
        if(allLogs.isEmpty()){
